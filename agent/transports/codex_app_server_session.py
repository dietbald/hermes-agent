...
class CodexAppServerSession:
    ...
    def ensure_started(self) -> str:
        ...
        # Pin the Codex thread to Hermes' selected model. Without this,
        # app-server silently inherits the model from ~/.codex/config.toml,
        # so a Hermes profile configured for (for example) Codex Spark can
        # consume the user's general Codex allowance instead.
        if self._model:
